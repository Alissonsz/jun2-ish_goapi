...
reset-migrations-test:
	goose -dir "server/database/migrations" postgres "user=postgres password=mysecretpassword dbname=jun2-ish_test_db sslmode=disable host=localhost" reset
